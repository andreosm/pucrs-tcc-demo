...
class State {
  constructor(name = null, code = null, fips = null) {
    this.name = name;
    this.code = code;
    this.fips = fips;
  ...
  async get(propertyName = null, propertyValue = null) {
    ...
    switch (propertyName) {
      case 'name':
        queryName = QUERY.GET_STATE_BY_NAME;
        break;
      case 'code':
        queryName = QUERY.GET_STATE_BY_CODE;
        break;
      case 'fips':
        queryName = QUERY.GET_STATE_BY_FIPS;
        break;
      default:
        queryName = QUERY.GET_STATES;
    }
    ...
    try {
      ...
      console.error(`Error fetching states${propertyName ? " by " + propertyName : ""}:`, err.message);
      throw new Error(`Database error while fetching states${propertyName ? " by " + propertyName : ""}`);
    }
